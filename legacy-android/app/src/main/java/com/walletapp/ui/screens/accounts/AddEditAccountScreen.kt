...
fun AddEditAccountScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(if (state.id == 0L) "Nueva cuenta" else "Editar cuenta") },
                navigationIcon = {
        ...
        Column(
            ...
            Row(
                ...
                CategoryPalette.forEach { color ->
                    ...
                    ColorDot(
                        color = color,
                        selected = state.colorHex.equals(hex, ignoreCase = true),
            ...
            Row(
                ...
                Text("Incluir en balance total", style = MaterialTheme.typography.bodyLarge)
                Switch(
                    checked = state.includeInTotal,
                    onCheckedChange = viewModel::setIncludeInTotal
                )
            }
